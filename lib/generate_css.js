...
const ejs              = require("ejs"),
      ...
      DefaultUrlKeys   = require("./aliases");
...
function getURLKeyForLocale(locale, urls) {
  ...
  // fifth, look in DefaultUrlKeys to see if the locale is specified.
  // sixth, look in DefaultUrlKeys to see if the baseLocale is specified.
  // seventh, fall back to default.
