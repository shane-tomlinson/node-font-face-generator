...
function supportsWoff2(ua) {
  return ua === 'all'
      || (ua.family === 'Firefox' && ua.major >= 39)
      || (ua.family === 'Chrome' && ua.major >= 36)
      || (ua.family === 'Opera' && ua.major >= 23);
}
...
function getSupportedFormatsForUA(ua) {
  var parsedUA = ua === 'all' ? ua : ua_parser.parse(ua).ua;
