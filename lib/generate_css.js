...
function getURLKeyForLocale(locale) {
  ...
  // If no locale specific font set is found, use the default font set.
  return localeToURLKeys[locale] || localeToURLKeys[baseLocale] || "default";
}
...
function getURLForLocale(locale, urls) {
  ...
  return urls[getURLKeyForLocale(locale)] || urls["default"];
}
